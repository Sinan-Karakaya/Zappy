...
Test (direction_east, get_direction_north)
{
    ...
    client->info->player->direction = EAST;
...
Test (direction_east, get_direction_northw)
{
    client_t *client = malloc(sizeof(client_t));
    client_t *other = malloc(sizeof(client_t));
...
Test (direction_east, get_direction_west)
{
    client_t *client = malloc(sizeof(client_t));
    client_t *other = malloc(sizeof(client_t));
...
Test (direction_east, get_direction_southw)
{
    client_t *client = malloc(sizeof(client_t));
    client_t *other = malloc(sizeof(client_t));
...
Test (direction_east, get_direction_south)
{
    client_t *client = malloc(sizeof(client_t));
    client_t *other = malloc(sizeof(client_t));
...
Test (direction_east, get_direction_southe)
{
    client_t *client = malloc(sizeof(client_t));
    client_t *other = malloc(sizeof(client_t));
...
Test (direction_east, get_direction_east)
{
    client_t *client = malloc(sizeof(client_t));
    client_t *other = malloc(sizeof(client_t));
...
Test (direction_east, get_direction_northe)
{
    client_t *client = malloc(sizeof(client_t));
    client_t *other = malloc(sizeof(client_t));
